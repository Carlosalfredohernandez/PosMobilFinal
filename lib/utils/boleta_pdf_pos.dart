...
class BoletaPdfPosGenerator {
  /// Genera el PDF desde el mapa de boleta y lo muestra en pantalla (vista previa), usando el mismo formato que generarPdfDesdeMapa
  static Future<void> generarYMostrarPdfDesdeMapa(Map<String, dynamic> boleta) async {
    final pdf = pw.Document();
    // --- Copia la lógica de generarPdfDesdeMapa, pero sin guardar archivo ---
